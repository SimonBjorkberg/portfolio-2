...
export default function Info() {
    ...
    return (
        <section className="bg-[#50343c] bg-dot-grid h-dvh content-start pt-14 px-4 md:px-0">
            <div className="flex flex-col justify-between h-[60%]">
                <div className="flex flex-col items-start self-center p-0">
                    ...
                    <div className="pt-5 max-w-[500px] text-[18px] ">
                    ...
                    <ul className="flex w-fit flex-wrap gap-2 pt-5">
                ...
                <div className="flex flex-col md:flex-row self-center">
                    <p className="flex items-center mr-[50px]">
                        Tech Stack:
                    </p>
                    <ul className="flex w-fit flex-wrap gap-5">
                        {icons && icons.map((icon, i) => {
                            return <li className="justify-center flex w-[36px] h-[36px]" key={i}><Image src={icon} alt="icon" /></li>
                        })}
                    </ul>
                </div>
            </div>
